                ...
                <div className="flex flex-col gap-12 justify-center items-center pt-6 text-center">
                    ...
                    >
                        ...
                        <div className="w-full">
                            <h1 className="text-center text-xl text-white font-bold mt-3 mb-2">
                                BUY BEFORE PRICE INCREASE!
                            </h1>

                            <h1 className="text-center text-lg text-white font-bold mt-2 mb-1">
                                <span className="text-2xl">$</span> 0.01 = 1 EDC
                            </h1>


                            <h1 className="text-center text-md text-white font-bold my-1">
                                Your Purchased EDC : 0
                            </h1>

                            <div className="flex flex-col justify-center items-center gap-2 mt-3 mb-2">
                                ...
                                <h1 className="text-center text-md text-white font-bold my-2">
                            ...
                            <div className="mt-1 mb-2 w-full flex flex-col gap-1">
                                <div className="my-1">
                                    <h1 className="text-md text-left text-white font-bold my-2">
                                        Amount Of ETH
                                    </h1>

                                    <input
                                        className="w-[100%] text-white border font-medium bg-[#121212] border-gray-700 focus:border-zinc-900 text-md outline-none py-1 px-2leading-8"
                                        placeholder="0.1 ETH"
                                        type="number"
                                    />
                                </div>
                                ...
                                <Button
                                    className="text-md my-2 font-bold tracking-widest rounded-none bg-red-600 hover:bg-black text-white hover:text-[#FEDE00] py-5"
                                >
                                    BUY EDC
                                </Button>
                            </div>
