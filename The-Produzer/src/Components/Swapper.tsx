...
const Swapper = () => {
    return (
        <div className="py-8 px-5 md:p-10 mt-12 lg:mt-6 mb-12 lg:mb-10 bg-orange-600 border border-gray-300 dark:border-stone-700 shadow-md shadow-zinc-950 dark:shadow-slate-600">
